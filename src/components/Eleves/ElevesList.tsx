...
export default function ElevesList({ onEleveSelect, onNewEleve }: ElevesListProps) {
  ...
  const autoDetectMapping = () => {
    ...
    const auto = {
      matricule: pick(['matric', 'matri', 'id', 'numero', 'num', 'code']),
      nom: pick(['nom', 'lastname', 'surname', 'family']),
      prenoms: pick(['prenom', 'prénom', 'given', 'prenoms', 'firstname']),
      nomPrenoms: pick(['nom_prenom', 'nom_prenoms', 'nomprenom', 'nom et prenoms', 'nom et pr', 'nom & prénoms', 'nom & prenoms'])
    };
